...
@section('CDOE', 'Online MBA in Operations Strategy & Project Management at TMU – Admissions Open')
...
@section('content')
    ...
    <div class="programme-banner">
        <picture>
            <source media="(max-width: 767px)" srcset="{{ asset('assets/img/programmes/online_mba_ops_mobile.webp') }}">
            <source media="(max-width: 991px)" srcset="{{ asset('assets/img/programmes/online_mba_ops_tablet.webp') }}">
            <img src="{{ asset('assets/img/programmes/online_mba_ops_desktop.webp') }}" alt="Online MBA in Operations Strategy & Project Management" fetchpriority="high" decoding="async" class="w-100">
        </picture>
        <div class="banner-title d-none d-md-block">
            <p>Online MBA in <br> <span>Operations Strategy & Project Management</span></p>
            <p class="d-none d-lg-block">Turn operational challenges into business results with an Online MBA in Operations Strategy & Project Management. Develop skills in process planning, project execution, resource management and strategic decision-making through convenient online learning.</p>
        </div>
    </div>

    <div class="course-single-area pd-top-60 pd-bottom-90">
        <div class="section-header">
            <h1 style="font-size:2.5rem;">Online MBA in <span class="highlight" style="color:#ff7900">Operations Strategy & Project Management</span></h1>
        </div>
        <div class="row">
            <div class="col-lg-12">
                    ...
                    <div class="course-section container" id="description-section">
                        <div class="course-details-content">
                            <h2 style="font-size: 1.85rem; font-weight: 700; color: #001d4a; margin-bottom: 1.2rem;">
                                Online MBA in Operations Strategy & Project Management <span style="color:#ff7900;">Programme Details</span>
                            </h2>
                            <p>An <b>Online MBA in Operations Strategy & Project Management at <a href="https://www.tmu.ac.in/" target="_blank" rel="noopener">TMU</a></b> is a postgraduate management programme that focuses on how modern businesses plan, execute, optimize and lead their day-to-day operations and complex projects. Students master critical areas such as operations management, strategic project planning, supply chain optimization, business agility, quality control, and enterprise risk management through flexible online learning.</p>
                            <p>The programme is designed for ambitious professionals and graduates who want to develop executive skills in leading teams, maximizing organizational resources, streamlining business workflows, and executing projects efficiently.</p>
                            <p>Learners gain hands-on expertise in managing project lifecycles, budgets, deadlines, and cross-functional teams while consistently upholding quality standards and strategic business goals. The programme opens pathways to leadership careers in operations, project management, supply chain, management consulting, and business transformation across IT, manufacturing, healthcare, logistics, retail, banking, and global services.</p>

                            <h2 class="mt-5 mb-3" style="font-size: 1.85rem; font-weight: 700; color: #001d4a;">Why Choose an Online MBA in Operations Strategy & Project Management</h2>
                            <div class="row pt-2">
                                <div class="col-sm-6">
                                    <ul class="single-list-wrap">
                                        <li class="single-list-inner style-check-box">
                                            <i class="fa fa-check"></i> Build leadership & executive management skills
                                        </li>
                                        <li class="single-list-inner style-check-box">
                                            <i class="fa fa-check"></i> Learn end-to-end operations strategy & optimization
                                        </li>
                                        <li class="single-list-inner style-check-box">
                                            <i class="fa fa-check"></i> Develop comprehensive project management expertise
                                        </li>
                                        <li class="single-list-inner style-check-box">
                                            <i class="fa fa-check"></i> Improve data-driven strategic decision-making
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 mt-3 mt-sm-0">
                                    <ul class="single-list-wrap">
                                        <li class="single-list-inner style-check-box">
                                            <i class="fa fa-check"></i> Enhance business process efficiency & quality
                                        </li>
                                        <li class="single-list-inner style-check-box">
                                            <i class="fa fa-check"></i> Learn enterprise risk management & mitigation
                                        </li>
                                        <li class="single-list-inner style-check-box">
                                            <i class="fa fa-check"></i> Strengthen analytical problem-solving capabilities
                                        </li>
                                        <li class="single-list-inner style-check-box">
                                            <i class="fa fa-check"></i> Prepare for high-growth managerial & leadership roles
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <section class="career-paths-section px-1 px-lg-5">
                        <div class="container-fluid">
                            ...
                            <div class="career-paths-header">
                                <h2>Career Paths After <span>Online MBA in Operations Strategy & Project Management</span></h2>
                                <p>An Online MBA in Operations Strategy & Project Management prepares students for roles that involve planning, process improvement, project execution, and business operations. Graduates can work across industries such as IT, manufacturing, consulting, logistics, healthcare, retail, and e-commerce. <br> Here are some career paths you can explore after graduation:</p>
                            </div>
                            ...
                            <div class="career-paths-content">
                                ...
                                <div class="career-paths-image-col">
                                    <img src="{{ asset('assets/img/programmes/prog-img-4.jpg') }}" alt="Operations Strategy and Project Management Career Paths" class="career-image">
                                </div>
                                ...
                                <div class="career-paths-list-col">
                                    <ul class="career-path-list pl-3">
                                        ...
                                        <li class="career-path-item">
                                            <i class="fas fa-check-circle"></i> Project Manager
                                        </li>
                                        <li class="career-path-item">
                                            <i class="fas fa-check-circle"></i> Project Coordinator
                                        </li>
                                        <li class="career-path-item">
                                            <i class="fas fa-check-circle"></i> Operations Analyst
                                        </li>
                                        <li class="career-path-item">
                                            <i class="fas fa-check-circle"></i> Business Operations Manager
                                        </li>
                                        <li class="career-path-item">
                                            <i class="fas fa-check-circle"></i> Supply Chain Manager
                                        </li>
                                        <li class="career-path-item">
                                            <i class="fas fa-check-circle"></i> Process Improvement Manager
                                        </li>
                                        <li class="career-path-item">
                                            <i class="fas fa-check-circle"></i> Program Manager
                                        </li>
                                        <li class="career-path-item">
                                            <i class="fas fa-check-circle"></i> Project Management Consultant
                                        </li>
                                        <li class="career-path-item">
                                ...
                                <div class="eligibility-content">
                                    ...
                                    <div class="eligibility-text">
                                        ...
                                        <ul class="eligibility-list">
                                            ...
                                            <li>
                                                <i class="fas fa-check-circle"></i>
                                                <span>Minimum 50% marks in graduation (relaxation of 5% marks for reserved category candidates as per norms).</span>
                                            </li>
                                            <li>
                                                <i class="fas fa-check-circle"></i>
                                            ...
                                            <li>
                                                <i class="fas fa-check-circle"></i>
                                                <span>No specific prior work experience is required.</span>
                                            </li>
                                            <li>
                                                <i class="fas fa-check-circle"></i>
                                                <span>Applicants from any academic stream (Arts, Science, Commerce, Engineering, etc.) are eligible to apply.</span>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div id="faq-accordion" class="accordion-area mt-4">
                                ...
                                <div class="card single-faq-inner style-header-bg">
                                    <div class="card-header" id="ff-one">
                                        <h5 class="mb-0">
                                            <button class="btn-link" data-toggle="collapse" data-target="#f-one"
                                                ...
                                                01. Which is a better MBA: Finance or Operations?
                                                <i class="fa fa-eye"></i>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="f-one" class="collapse show" aria-labelledby="ff-one"
                                        ...
                                        <div class="card-body">
                                            Both are good options. MBA in Finance is better for careers in banking, investment, accounting and financial management, while an MBA in Operations is suitable for supply chain, logistics, production and process management.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card single-faq-inner style-header-bg">
                                    <div class="card-header" id="ff-two">
                                        <h5 class="mb-0">
                                            <button class="btn-link collapsed" data-toggle="collapse" data-target="#f-two"
                                                ...
                                                02. What do you study in an MBA in Operations Strategy & Project Management?
                                                <i class="fa fa-eye"></i>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="f-two" class="collapse" aria-labelledby="ff-two"
                                        data-parent="#faq-accordion">
                                        <div class="card-body">
                                            You typically study operations management, project management, business strategy, supply chain management, quality management and risk management.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card single-faq-inner style-header-bg">
                                    <div class="card-header" id="ff-three">
                                        <h5 class="mb-0">
                                            <button class="btn-link collapsed" data-toggle="collapse" data-target="#f-three"
                                                ...
                                                03. What skills are required for operations and project management?
                                                <i class="fa fa-eye"></i>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="f-three" class="collapse" aria-labelledby="ff-three"
                                        data-parent="#faq-accordion">
                                        <div class="card-body">
                                            Important skills include leadership, problem-solving, communication, planning, decision-making and time management.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card single-faq-inner style-header-bg">
                                    <div class="card-header" id="ff-four">
                                        <h5 class="mb-0">
                                            <button class="btn-link collapsed" data-toggle="collapse" data-target="#f-four"
                                                ...
                                                04. Can I pursue an MBA in Operations Strategy & Project Management online?
                                                <i class="fa fa-eye"></i>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="f-four" class="collapse" aria-labelledby="ff-four"
                                        data-parent="#faq-accordion">
                                        <div class="card-body">
                                            Yes, several universities offer MBA programmes in operations and related management specialisations through online learning, allowing professionals to balance work and studies flexibly.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card single-faq-inner style-header-bg">
                                    <div class="card-header" id="ff-five">
                                        <h5 class="mb-0">
                                            <button class="btn-link collapsed" data-toggle="collapse" data-target="#f-five"
                                                ...
                                                05. What industries hire operations and project management professionals?
                                                <i class="fa fa-eye"></i>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="f-five" class="collapse" aria-labelledby="ff-five"
                                        data-parent="#faq-accordion">
                                        <div class="card-body">
                                            Professionals can find opportunities in IT, manufacturing, healthcare, logistics, consulting, retail, banking, e-commerce and various other industries.
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card single-faq-inner style-header-bg">
                                    <div class="card-header" id="ff-six">
                                        <h5 class="mb-0">
                                            <button class="btn-link collapsed" data-toggle="collapse" data-target="#f-six"
                                                ...
                                                06. What is the difference between operations management and project management?
                                                <i class="fa fa-eye"></i>
                                            </button>
                                        </h5>
                                    </div>
                                    <div id="f-six" class="collapse" aria-labelledby="ff-six"
                                        data-parent="#faq-accordion">
                                        <div class="card-body">
                                            Operations management focuses on ongoing business processes, while project management focuses on planning and completing specific projects with defined timelines and deliverables.
                                        </div>
                                    </div>
                                </div>
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        {
          "@type": "Course",
          "name": "Online MBA in Operations Strategy & Project Management",
          "description": "Explore an Online MBA in Operations Strategy & Project Management, including course details, fees, eligibility, duration, syllabus and career options.",
          "provider": {
          ...
          "occupationalCredentialAwarded": "Postgraduate Degree",
          "hasCourseInstance": {
            "@type": "CourseInstance",
            "courseMode": "Online",
            "duration": "P2Y"
        ...
        },
        {
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "Which is a better MBA: Finance or Operations?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Both are good options. MBA in Finance is better for careers in banking, investment, accounting and financial management, while an MBA in Operations is suitable for supply chain, logistics, production and process management."
              }
            },
            {
              "@type": "Question",
              "name": "What do you study in an MBA in Operations Strategy & Project Management?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "You typically study operations management, project management, business strategy, supply chain management, quality management and risk management."
              }
            },
            {
              "@type": "Question",
              "name": "What skills are required for operations and project management?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Important skills include leadership, problem-solving, communication, planning, decision-making and time management."
              }
            },
            {
              "@type": "Question",
              "name": "Can I pursue an MBA in Operations Strategy & Project Management online?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, several universities offer MBA programmes in operations and related management specialisations through online learning."
              }
            },
            {
              "@type": "Question",
              "name": "What industries hire operations and project management professionals?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Professionals can find opportunities in IT, manufacturing, healthcare, logistics, consulting, retail, banking and other industries."
              }
            },
            {
              "@type": "Question",
              "name": "What is the difference between operations management and project management?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Operations management focuses on ongoing business processes, while project management focuses on planning and completing specific projects."
              }
            }
          ]
        }
