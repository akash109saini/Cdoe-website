...
@section('content')
    ...
    <script type="application/ld+json">
    {
      ...
      "@graph": [
        {
          "@type": "Course",
          "name": "Online BCA in Game Design & AR/VR",
          "description": "Discover Online BCA in Game Design & AR/VR at TMU. Learn Unity, Unreal Engine, 3D modeling, game mechanics, and virtual reality development.",
          "provider": {
        ...
        },
        {
          ...
          "mainEntity": [
            {
              "@type": "Question",
              "name": "What is BCA in Game Design & AR/VR?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "It is a specialized 3-year undergraduate degree teaching game programming, 3D modeling, Unity/Unreal engines, and augmented/virtual reality development alongside core computer applications."
              }
            },
            {
              "@type": "Question",
              "name": "Is game design a good career option in India and abroad?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, the global video game and XR market is larger than the movie and music industries combined, generating thousands of high-paying jobs in development, graphics, and interactive design."
              }
            },
            {
              "@type": "Question",
              "name": "Which game engines and tools are covered?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Popular industry tools including Unity, Unreal Engine, Blender, Maya fundamentals, C#, C++, and XR development kits like ARCore and OpenXR."
              }
            },
            {
              "@type": "Question",
              "name": "Can I build non-gaming applications with AR/VR skills?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Absolutely. AR/VR skills are widely used in medical surgery simulations, defense training, real estate architectural visualization, automotive engineering, and virtual education."
              }
            },
            {
              "@type": "Question",
              "name": "Can students from non-science streams enroll in this program?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Yes, students from all academic streams (Science, Commerce, Arts) who meet 10+2 eligibility can apply."
              }
            },
            {
              "@type": "Question",
              "name": "Do I need an expensive gaming computer to study online?",
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Standard modern laptops can handle foundational coding and initial 3D design; cloud labs and optimized development settings are utilized throughout the program."
              }
            }
          ]
        }
